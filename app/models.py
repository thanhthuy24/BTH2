...
class Categories(db.Model):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True ) #autoincrease là tự động tăng giống identity trong sql server
    ...
    products = relationship('Product', backref='category', lazy=True) #backref thêm tự động vào product 1 trường category
...
if __name__ == '__main__':
    with app.app_context():
        ...
        p1 = Product(name='iPhone 13', price=20000000, category_id=1, image="https://th.bing.com/th/id/OIP.D2L5Emr_tkvju5Hilr22DgHaHa?pid=ImgDet&rs=1")
